...
reduce.method([_, undefined, is(Array)],
  (callbackfn, initialValue, array) =>
    array.reduce((previousValue, currentValue) =>
      callbackfn(previousValue, currentValue))
)
...
reduce.method([is(Function), _, is(Map)],
  (callbackfn, initialValue, map) =>
    [...map.entries()].reduce(callbackfn, initialValue)
)

reduce.method([is(Function), undefined, is(Map)],
  (callbackfn, initialValue, map) =>
    [...map.entries()].reduce(callbackfn)
)
